...
- [x] Cut pragmatic v0.1.0 release for a private downstream service.
  ...
  - Evidence: current no-broker default `crystal spec --error-trace` exits 0: 215 examples, 0 failures, 0 errors, 92 pending.
...
- [x] Re-run the full current verification baseline.
  ...
  - Evidence: current no-broker default full `crystal spec --error-trace` exits 0: 215 examples, 0 failures, 0 errors, 92 pending.
...
- [x] Fix `Amqp::Message` string/IO body ownership.
  ...
  - Evidence: `/opt/homebrew/bin/crystal spec --error-trace` exits 0: 215 examples, 0 failures, 0 errors, 92 pending without a live broker.
...
- [x] Add NamedTuple `args` sugar for topology and consumer helpers.
  ...
  - Evidence: full no-broker `/opt/homebrew/bin/crystal spec --error-trace` exits 0: 215 examples, 0 failures, 0 errors, 92 pending.
  - Evidence: `/opt/homebrew/bin/crystal tool format --check src spec tools/perf_publish.cr`, `/opt/homebrew/bin/crystal build tools/perf_publish.cr --release --no-codegen --error-trace`, and `git diff --check` exit 0.
- [x] Close practical feature parity gaps with `amqp-client.cr`.
  ...
  - Evidence: latest no-broker full `crystal spec --error-trace` exits 0: 215 examples, 0 failures, 0 errors, 92 pending.
