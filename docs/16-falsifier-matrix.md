...
`T-PERF-MULTICHAN-001`, `T-PERF-CONS-001`, and `T-PERF-STATS-001` have
default-off carriers under `spec/perf/`. The remaining `T-PERF-*` rows
are reserved roadmap falsifiers until their carriers exist. None of
